...
export default function LandingPage() {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    // Store email in localStorage for now, will connect to API later
      ...
      <section className="max-w-6xl mx-auto px-6 pt-20 pb-32">
        <div className="text-center max-w-3xl mx-auto">
          ...
          <h1 className="text-5xl md:text-6xl font-bold leading-tight mb-6">
            Know Your <span className="text-gradient">DeFi Taxes</span> Before the IRS Does
          </h1>
          
          <p className="text-xl text-[#71717a] mb-10 leading-relaxed">
            The only tax tool built specifically for DeFi traders. Connect your wallets, 
            track your real-time tax liability, and generate IRS-ready reports. 
            Built for yield farmers, LP providers, and DeFi power users.
          </p>
        ...
        {/* Hero Visual */}
        <div className="mt-16 card p-1 max-w-4xl mx-auto">
          <div className="bg-[#0a0a0f] rounded-lg p-6 font-mono text-sm">
            <div className="flex items-center gap-2 mb-4">
              <div className="w-3 h-3 rounded-full bg-red-500"></div>
              <div className="w-3 h-3 rounded-full bg-yellow-500"></div>
              <div className="w-3 h-3 rounded-full bg-green-500"></div>
              <span className="text-[#71717a] ml-2">DefiTax Dashboard</span>
            </div>
            <div className="grid grid-cols-3 gap-4 mb-6">
              <div className="bg-[#111118] rounded-lg p-4">
                <p className="text-[#71717a] text-xs mb-1">Estimated Tax Liability</p>
                <p className="text-2xl font-bold text-white">$4,218</p>
                <p className="text-xs text-green-400 mt-1">↓ 12% from last month</p>
              </div>
              <div className="bg-[#111118] rounded-lg p-4">
                <p className="text-[#71717a] text-xs mb-1">Unrealized Gains</p>
                <p className="text-2xl font-bold text-white">$12,847</p>
                <p className="text-xs text-[#71717a] mt-1">Across 3 chains</p>
              </div>
              <div className="bg-[#111118] rounded-lg p-4">
                <p className="text-[#71717a] text-xs mb-1">Loss Harvest Opportunity</p>
                <p className="text-2xl font-bold text-yellow-400">$1,932</p>
            ...
            <div className="space-y-2">
              <div className="flex justify-between items-center py-2 border-b border-[#1e1e2e]">
                <span className="text-[#71717a]">SOL → USDC (Raydium)</span>
                <span className="text-green-400">+$2,340</span>
              </div>
              <div className="flex justify-between items-center py-2 border-b border-[#1e1e2e]">
                <span className="text-[#71717a]">ETH/USDC LP (Uniswap V3)</span>
                <span className="text-red-400">-$890</span>
              </div>
              <div className="flex justify-between items-center py-2 border-b border-[#1e1e2e]">
                <span className="text-[#71717a]">Staking Rewards (Marinade)</span>
                <span className="text-green-400">+$156</span>
              </div>
              <div className="flex justify-between items-center py-2">
                <span className="text-[#71717a]">Airdrop (Jupiter)</span>
      ...
      <section id="pricing" className="max-w-6xl mx-auto px-6 py-20">
        ...
        <div className="grid md:grid-cols-3 gap-6 max-w-4xl mx-auto">
          ...
          <div className="card p-6">
            ...
            <Link href="/dashboard" className="btn-secondary w-full block text-center text-sm">
              Get Started
            </Link>
          </div>
